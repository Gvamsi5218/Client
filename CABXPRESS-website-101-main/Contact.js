                            ...
                            <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a href="https://maps.app.goo.gl/VcFHynuHBaNXk1ax5">
                                            <p className="mb-0">206,Runway Heights,Ayodhya Chowk,Rajkot 360006</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a href="tel:+919904500064">
                                            <p className="mb-0">+91-9904500064</p>
                                        </a>
                                        <a href="tel:+919904500062">
                                            <p className="mb-0">+91-9904500062</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a href="mailto:info@cabxprerss.in">
                                            <p className="mb-0">info@cabxprerss.in</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
